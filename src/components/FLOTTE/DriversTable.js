...
import AddDriverModal from "./NewDriver"; // 
...
const DriversTable = () => {
  ...
  return (
    <>
      ...
      <AddDriverModal isOpen={modalOpen} toggle={toggleModal} />
      <EditDriverModal
        isOpen={editModalOpen}
        toggle={toggleEditModal}
        driver={selectedDriver}
        setDriversList={setDriversList} // Passer la fonction pour mettre à jour la liste
      />
    </>
  );
};
